...
for forbidden in 'com.apple.security.network.server' 'com.apple.security.cs.disable-library-validation' 'com.apple.security.cs.allow-unsigned-executable-memory'; do
